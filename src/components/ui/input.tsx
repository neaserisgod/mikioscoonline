...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <InputPrimitive
      type={type}
      data-slot="input"
      // Cero fricción: en inputs numéricos, enfocar selecciona el valor —
      // tipeás y reemplaza sin tener que borrar primero. Un onFocus explícito
      // en props lo pisa (va después en el spread).
