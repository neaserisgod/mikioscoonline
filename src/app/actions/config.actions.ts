...
const MedioPagoSchema = z.object({
  ...
  // Si una venta se cobra con este medio, se factura automáticamente por AFIP
  facturarAutomaticamente: z.boolean().optional(),
})
...
const NegocioSchema = z.object({
  ...
  // Modelo financiero (ver docs/MODELO-FINANCIERO.md) — resumenService.reparto/mes
